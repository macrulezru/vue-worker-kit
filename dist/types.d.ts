 ...
 */
export type WorkerModuleInput<T> = T extends {
    default: WorkerHandlerModule<infer In, unknown>;
} ? In : never;
export type WorkerModuleOutput<T> = T extends {
    default: WorkerHandlerModule<unknown, infer Out>;
} ? Out : never;
/** Simple hash function for cache keys */
export declare function createCacheKey(input: unknown): string;
